"""offset_mapping 기반 word2ph_tok 계산 (독립 버전 — Style-Bert-VITS2 의존성 없음)."""

from decompose import _is_korean_or_punct, text_to_jamo_counts
...
def _distribute(total: int, n: int) -> list[int]:
    """total을 n개로 최대한 균등 분배. 나머지는 앞쪽에 배분."""
